...
console.log(PRODUCT)//{ name: 'FactoryA:ConcreteProductB' }

PRODUCT = AbstractFactory.createObject('bc')
console.log(PRODUCT)//{ name: 'FactoryB:ConcreteProductC' }

PRODUCT = AbstractFactory.createObject('cc') //error message when No Factory found
console.log(PRODUCT)
